var togNum = 1;
var togNum1 = 1;
    d3.csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vSDkI0yGIEMnHCxUVsIZL6K50rwdYODEJJJeiT6bYfw9Msw2S9UAyxSPnZZ31U1ZL13ZqI-2cdQX3dv/pub?gid=414287731&single=true&output=csv", function (data) {
  ...
  //wChart.addSeries("Location", dimple.plot.line);
        ...
        */
        ...
        //seperation
                          ...
                          isepdata1 = dimple.filterData(dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Industry"), "Indicator Value", ["Accommodation and Food Services", "Administrative and Support and Waste Management and Remediation Services", "Agriculture, Forestry, Fishing and Hunting", "Arts, Entertainment, and Recreation", "Construction", "Educational Services", "Finance and Insurance", "Health Care and Social Assistance", "Information", "Management of Companies and Enterprises", "Manufacturing", "Mining, Quarrying, and Oil and Gas Extraction", "Other Services (except Public Administration)", "Professional, Scientific, and Technical Services", "Public Administration", "Real Estate and Rental and Leasing", "Retail Trade", "Transportation and Warehousing", "Utilities", "Wholesale Trade"]), "Location", CountyName2), "Time", "2016-Q1"  );
        
                           isepdata2 = dimple.filterData(dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Industry"), "Indicator Value", ["Accommodation and Food Services", "Administrative and Support and Waste Management and Remediation Services", "Agriculture, Forestry, Fishing and Hunting", "Arts, Entertainment, and Recreation", "Construction", "Educational Services", "Finance and Insurance", "Health Care and Social Assistance", "Information", "Management of Companies and Enterprises", "Manufacturing", "Mining, Quarrying, and Oil and Gas Extraction", "Other Services (except Public Administration)", "Professional, Scientific, and Technical Services", "Public Administration", "Real Estate and Rental and Leasing", "Retail Trade", "Transportation and Warehousing", "Utilities", "Wholesale Trade"]), "Location", CountyName2), "Time", "2016-Q2"  );

                           isepdata3 = dimple.filterData(dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Industry"), "Indicator Value", ["Accommodation and Food Services", "Administrative and Support and Waste Management and Remediation Services", "Agriculture, Forestry, Fishing and Hunting", "Arts, Entertainment, and Recreation", "Construction", "Educational Services", "Finance and Insurance", "Health Care and Social Assistance", "Information", "Management of Companies and Enterprises", "Manufacturing", "Mining, Quarrying, and Oil and Gas Extraction", "Other Services (except Public Administration)", "Professional, Scientific, and Technical Services", "Public Administration", "Real Estate and Rental and Leasing", "Retail Trade", "Transportation and Warehousing", "Utilities", "Wholesale Trade"]), "Location", CountyName2), "Time", "2016-Q3"  );

                           isepdata4 = dimple.filterData(dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Industry"), "Indicator Value", ["Accommodation and Food Services", "Administrative and Support and Waste Management and Remediation Services", "Agriculture, Forestry, Fishing and Hunting", "Arts, Entertainment, and Recreation", "Construction", "Educational Services", "Finance and Insurance", "Health Care and Social Assistance", "Information", "Management of Companies and Enterprises", "Manufacturing", "Mining, Quarrying, and Oil and Gas Extraction", "Other Services (except Public Administration)", "Professional, Scientific, and Technical Services", "Public Administration", "Real Estate and Rental and Leasing", "Retail Trade", "Transportation and Warehousing", "Utilities", "Wholesale Trade"]), "Location", CountyName2), "Time", "2016-Q4"  );

                           isepdata5 = dimple.filterData(dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Industry"), "Indicator Value", ["Accommodation and Food Services", "Administrative and Support and Waste Management and Remediation Services", "Agriculture, Forestry, Fishing and Hunting", "Arts, Entertainment, and Recreation", "Construction", "Educational Services", "Finance and Insurance", "Health Care and Social Assistance", "Information", "Management of Companies and Enterprises", "Manufacturing", "Mining, Quarrying, and Oil and Gas Extraction", "Other Services (except Public Administration)", "Professional, Scientific, and Technical Services", "Public Administration", "Real Estate and Rental and Leasing", "Retail Trade", "Transportation and Warehousing", "Utilities", "Wholesale Trade"]), "Location", CountyName2), "Time", "2017-Q1"  );

                           isepdata6 = dimple.filterData(dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Industry"), "Indicator Value", ["Accommodation and Food Services", "Administrative and Support and Waste Management and Remediation Services", "Agriculture, Forestry, Fishing and Hunting", "Arts, Entertainment, and Recreation", "Construction", "Educational Services", "Finance and Insurance", "Health Care and Social Assistance", "Information", "Management of Companies and Enterprises", "Manufacturing", "Mining, Quarrying, and Oil and Gas Extraction", "Other Services (except Public Administration)", "Professional, Scientific, and Technical Services", "Public Administration", "Real Estate and Rental and Leasing", "Retail Trade", "Transportation and Warehousing", "Utilities", "Wholesale Trade"]), "Location", CountyName2), "Time", "2017-Q2"  );

                           isepdata7 = dimple.filterData(dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Industry"), "Indicator Value", ["Accommodation and Food Services", "Administrative and Support and Waste Management and Remediation Services", "Agriculture, Forestry, Fishing and Hunting", "Arts, Entertainment, and Recreation", "Construction", "Educational Services", "Finance and Insurance", "Health Care and Social Assistance", "Information", "Management of Companies and Enterprises", "Manufacturing", "Mining, Quarrying, and Oil and Gas Extraction", "Other Services (except Public Administration)", "Professional, Scientific, and Technical Services", "Public Administration", "Real Estate and Rental and Leasing", "Retail Trade", "Transportation and Warehousing", "Utilities", "Wholesale Trade"]), "Location", CountyName2), "Time", "2017-Q3"  );

                           isepdata8 = dimple.filterData(dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Industry"), "Indicator Value", ["Accommodation and Food Services", "Administrative and Support and Waste Management and Remediation Services", "Agriculture, Forestry, Fishing and Hunting", "Arts, Entertainment, and Recreation", "Construction", "Educational Services", "Finance and Insurance", "Health Care and Social Assistance", "Information", "Management of Companies and Enterprises", "Manufacturing", "Mining, Quarrying, and Oil and Gas Extraction", "Other Services (except Public Administration)", "Professional, Scientific, and Technical Services", "Public Administration", "Real Estate and Rental and Leasing", "Retail Trade", "Transportation and Warehousing", "Utilities", "Wholesale Trade"]), "Location", CountyName2), "Time", "2017-Q4"  );
        
                           asepdata1 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Age"), "Location", CountyName2), "Time", "2016-Q1");
        
                           asepdata2 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Age"), "Location", CountyName2), "Time", "2016-Q2");

                           asepdata3 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Age"), "Location", CountyName2), "Time", "2016-Q3");

                           asepdata4 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Age"), "Location", CountyName2), "Time", "2016-Q4");

                           asepdata5 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Age"), "Location", CountyName2), "Time", "2017-Q1");
                           asepdata6 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Age"), "Location", CountyName2), "Time", "2017-Q2");

                           asepdata7 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Age"), "Location", CountyName2), "Time", "2017-Q3");

                           asepdata8 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Age"), "Location", CountyName2), "Time", "2017-Q4");
        
                           gsepdata1 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Gender"), "Location", CountyName2), "Time", "2016-Q1");
        
                           gsepdata2 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Gender"), "Location", CountyName2), "Time", "2016-Q2");

                           gsepdata3 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Gender"), "Location", CountyName2), "Time", "2016-Q3");

                           gsepdata4 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Gender"), "Location", CountyName2), "Time", "2016-Q4");

                           gsepdata5 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Gender"), "Location", CountyName2), "Time", "2017-Q1");
                           gsepdata6 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Gender"), "Location", CountyName2), "Time", "2017-Q2");

                           gsepdata7 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Gender"), "Location", CountyName2), "Time", "2017-Q3");

                           gsepdata8 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Gender"), "Location", CountyName2), "Time", "2017-Q4");
        
                           esepdata1 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Education"), "Location", CountyName2), "Time", "2016-Q1");
        
                           esepdata2 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Education"), "Location", CountyName2), "Time", "2016-Q2");

                           esepdata3 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Education"), "Location", CountyName2), "Time", "2016-Q3");

                           esepdata4 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Education"), "Location", CountyName2), "Time", "2016-Q4");

                           esepdata5 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Education"), "Location", CountyName2), "Time", "2017-Q1");
                           esepdata6 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Education"), "Location", CountyName2), "Time", "2017-Q2");

                           esepdata7 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Education"), "Location", CountyName2), "Time", "2017-Q3");

                           esepdata8 = dimple.filterData(dimple.filterData(dimple.filterData(data, "Indicator", "Maryland Seperations by Education"), "Location", CountyName2), "Time", "2017-Q4");
